...
class TestCourierLogin:
    ...
    @allure.title('Проверка ошибки при авторизации с неверным полем')
    @pytest.mark.parametrize("login, password", [('Sasaraf', '342342'), ('Safaraz', '1234')])

    def test_courier_auth_one_field_wrong(self, login, password):
        lc = LoginCourier()
